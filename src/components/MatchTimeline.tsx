    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between px-1">
        <div className="flex items-center gap-2">
          <span className="text-base sm:text-lg font-black text-slate-800">🏸 対戦スケジュール</span>
        ...
        {rounds.map((round) => {
          ...
          return (
            ...
            >
              ...
              {/* Match Details (1-Line Inline Court & Players) */}
                    ...
                    {isEditing ? (
                      ...
                      <div className="bg-slate-50 border border-slate-200 rounded-lg p-2 space-y-1.5">
                        ...
                        <div className="flex items-center gap-1.5 text-sm">
                          {/* Team 1 Dropdowns */}
                          <div className="flex-1 space-y-1 bg-blue-50 p-1.5 rounded border border-blue-200">
                          ...
                          {/* Team 2 Dropdowns */}
                          <div className="flex-1 space-y-1 bg-rose-50 p-1.5 rounded border border-rose-200">
                      ...
                      <div className="flex items-center gap-2 py-1 px-2 rounded-lg bg-slate-50 border border-slate-100">
                        ...
                        <div className="flex items-center justify-between flex-1 min-w-0 font-black text-base sm:text-lg">
                          ...
                          <span className="text-xs font-black text-slate-400 px-2 shrink-0 uppercase">
                            vs
                          </span>
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-3.5 shadow-sm space-y-2.5 mt-3">
        ...
        <div className="space-y-2 pt-0.5">
          <div className="flex items-center justify-between">
            <label htmlFor="timeline-lookahead-select" className="text-slate-800 text-sm sm:text-base font-bold flex items-center gap-1.5">
